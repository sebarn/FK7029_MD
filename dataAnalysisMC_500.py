...
#analyse data from Monte Carlo experiment wiht 500 particles
computeRDF = "no";

fileNameEnergy = "MC_500_energies.txt"
fileNamePosition = "MC_500_positions.txt"
fileNameRDF = "MC_500_RDF.txt"
fileNameRDFerrors = "MC_500_RDF_errors.txt"
...
plt.legend(loc=2)
plt.savefig('/home/sebastian/Dropbox/msc/FK7029/molDyn/tex/figures/sigmas_MC_500.png')
...
if(computeRDF == "yes"):
    ...
    print(numberSamples)
    numberBins = 300
    firstSample = numberSamples - 1200
    lastSample = numberSamples - 200   
...
#select points for error analysis in RDF and plot RDF
#normalize errors before plotting
nhis = 300
...
#plt.savefig('/home/sebastian/Dropbox/msc/FK7029/molDyn/tex/figures/errors_RDF_MC_500.png')
...
yErrorBar = np.array([0.0236,0.0109,0.0065, 0.0045])
...
plt.savefig('/home/sebastian/Dropbox/msc/FK7029/molDyn/tex/figures/RDF_MC_500.png')
